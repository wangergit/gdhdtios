...
/* harmony default export */ var login = ({
    ...
    computed: {
        validate: function validate() {
            var phone = /^[a-zA-Z\d]{6,20}$/.test(this.form.phone);
...
/* scopeId */
var __vue_scopeId__ = "data-v-3c9ebc64"
