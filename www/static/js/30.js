    ...
    methods: {
        ...
        onLoad: function onLoad() {
            ...
            Object(personal["g" /* queryIAddress */])(this.params).then(function (res) {
                ...
                (_list = _this3.list).push.apply(_list, toConsumableArray_default()(res.content));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-67ff29d8","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/about/address/index.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"common-address"},[_c('navigate',{attrs:{"title":"常用地址","position":"absolute"}}),_vm._v(" "),_c('div',{ref:"scrollWrapper",staticClass:"scroll-wrapper"},[_c('mu-load-more',{attrs:{"refreshing":_vm.refresh,"loading":_vm.loading},on:{"refresh":_vm.onRefresh,"load":_vm.onLoad}},[_c('mu-sub-header',{staticStyle:{"color":"#B4B4B4"}},[_vm._v("以下信息仅用于为您航线规划、推荐内容等")]),_vm._v(" "),(_vm.list.length)?_c('mu-list',{staticStyle:{"margin-bottom":"30px","padding":"0","background-color":"#fff"},attrs:{"dense":false}},_vm._l((_vm.list),function(item,index){return _c('swipe-cell',{key:index,attrs:{"right-width":88}},[_c('mu-list-item',{staticClass:"border-1px-b",attrs:{"ripple":false,"button":""},nativeOn:{"click":function($event){_vm.handlerItem(item)}}},[_c('mu-list-item-content',[_c('mu-list-item-title',[_vm._v(_vm._s(item.name))]),_vm._v(" "),(item.address)?_c('mu-list-item-sub-title',[_vm._v(_vm._s(item.address))]):_vm._e()],1),_vm._v(" "),_c('mu-list-item-action',{staticStyle:{"display":"flex","justify-content":"flex-end"}},[_c('mu-button',{staticClass:"list-item-button",attrs:{"color":"#5B8CC0","flat":""},on:{"click":function($event){_vm.handlerLocation(item)}}},[_vm._v("\n                                定位\n                            ")])],1)],1),_vm._v(" "),_c('mu-button',{staticClass:"delete",attrs:{"slot":"right","color":"#fff","flat":""},on:{"click":function($event){_vm.handlerDelete(item, index)}},slot:"right"},[_vm._v("\n                        删除\n                    ")])],1)})):_c('no-success',{attrs:{"text":"您还没有添加常用地址","height":"75vh"}})],1)],1),_vm._v(" "),_c('div',{staticClass:"add-button-wrapper"},[_c('mu-button',{staticClass:"button",attrs:{"color":"#fff","flat":""},on:{"click":_vm.saveAddress}},[_vm._v("添加")])],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ var about_address = (esExports);
// CONCATENATED MODULE: ./src/views/about/address/index.vue
function injectStyle (ssrContext) {
  __webpack_require__("/FOf")
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-67ff29d8"
