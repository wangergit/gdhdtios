    ...
    methods: {
        ...
        submit: function submit() {
            ...
            this.$refs.form.validate().then(function (result) {
                if (result) {
                    _this2.loading = true;
                    Object(personal["B" /* updateUserPassword */])(_this2.form).then(function (res) {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-24d8c5a3","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/about/data/password.vue
var render = function () {
var this$1 = this;
var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"data-editor-password"},[_c('navigate',{attrs:{"title":_vm.navigateTitle,"position":"absolute"}}),_vm._v(" "),_c('div',{staticClass:"scroll-wrapper"},[_c('mu-form',{ref:"form",attrs:{"model":_vm.form,"label-position":"left","label-width":"100"}},[_c('mu-form-item',{staticClass:"p-15 border-1px-b",attrs:{"prop":"oldPwd","label":"原密码","rules":_vm.passwordRules1}},[_c('mu-text-field',{attrs:{"placeholder":"请填写原密码","action-icon":_vm.visibility1 ? 'visibility' : 'visibility_off',"action-click":function () {this$1.visibility1 = !this$1.visibility1},"type":_vm.visibility1 ? 'message.vue' : 'password',"solo":"","full-width":""},model:{value:(_vm.form.oldPwd),callback:function ($$v) {_vm.$set(_vm.form, "oldPwd", $$v)},expression:"form.oldPwd"}})],1),_vm._v(" "),_c('mu-form-item',{staticClass:"p-15 border-1px-b",attrs:{"prop":"newPwd","label":"新密码","rules":_vm.passwordRules2}},[_c('mu-text-field',{attrs:{"placeholder":"6-20位字母、数字和符号","action-icon":_vm.visibility2 ? 'visibility' : 'visibility_off',"action-click":function () {this$1.visibility2 = !this$1.visibility2},"type":_vm.visibility2 ? 'message.vue' : 'password',"solo":"","full-width":""},model:{value:(_vm.form.newPwd),callback:function ($$v) {_vm.$set(_vm.form, "newPwd", $$v)},expression:"form.newPwd"}})],1),_vm._v(" "),_c('mu-form-item',{staticClass:"p-15 border-1px-b",attrs:{"prop":"confirmPwd","label":"确认新密码","rules":_vm.passwordRules3}},[_c('mu-text-field',{attrs:{"placeholder":"6-20位字母、数字和符号","action-icon":_vm.visibility3 ? 'visibility' : 'visibility_off',"action-click":function () {this$1.visibility3 = !this$1.visibility3},"type":_vm.visibility3 ? 'message.vue' : 'password',"solo":"","full-width":""},model:{value:(_vm.form.confirmPwd),callback:function ($$v) {_vm.$set(_vm.form, "confirmPwd", $$v)},expression:"form.confirmPwd"}})],1)],1),_vm._v(" "),_c('mu-button',{directives:[{name:"loading",rawName:"v-loading",value:(_vm.loading),expression:"loading"}],staticClass:"db ma w90 background-primary",attrs:{"color":"#fff","data-mu-loading-size":"24","disabled":_vm.loading,"flat":""},on:{"click":_vm.submit}},[_vm._v("提交\n        ")])],1)],1)}
var staticRenderFns = []
