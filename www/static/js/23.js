...
/* harmony default export */ var data_info = ({
    ...
    methods: {
        init: function init() {
            ...
            Object(personal["j" /* queryIInfo */])().then(function (res) {
                _this.form = res;
        ...
        submit: function submit() {
            ...
            this.$refs.form.validate().then(function (result) {
                if (result) {
                    ...
                    Object(personal["x" /* saveOrUpdateIInfo */])(_this2.form).then(function (res) {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-f2f2effc","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/about/data/info.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"about-info-editor"},[_c('navigate',{attrs:{"title":_vm.navigateTitle,"position":"absolute"}}),_vm._v(" "),_c('div',{staticClass:"scroll-wrapper"},[_c('mu-form',{ref:"form",staticClass:"pt-10",attrs:{"model":_vm.form,"label-position":"left","label-width":"100"}},[_c('mu-form-item',{staticClass:"p-15 border-1px-b",attrs:{"prop":"alias","label":"昵称","rules":_vm.aliasRules}},[_c('mu-text-field',{attrs:{"prop":"alias","placeholder":_vm.mode !== 1 ? '' : '请输入昵称',"disabled":_vm.mode !== 1,"solo":""},model:{value:(_vm.form.alias),callback:function ($$v) {_vm.$set(_vm.form, "alias", $$v)},expression:"form.alias"}})],1),_vm._v(" "),_c('mu-form-item',{staticClass:"p-15 border-1px-b",attrs:{"prop":"gender","label":"性别"}},[_c('mu-text-field',{attrs:{"prop":"sex","placeholder":_vm.mode !== 1 ? '' : '请输入性别',"disabled":_vm.mode !== 1,"solo":""},on:{"click":_vm.handlerSelected},model:{value:(_vm.form.sex),callback:function ($$v) {_vm.$set(_vm.form, "sex", $$v)},expression:"form.sex"}})],1),_vm._v(" "),_c('mu-form-item',{staticClass:"p-15 border-1px-b",attrs:{"prop":"age","label":"年龄","rules":_vm.ageRules}},[_c('mu-text-field',{attrs:{"prop":"age","placeholder":_vm.mode !== 1 ? '' : '请输入年龄',"disabled":_vm.mode !== 1,"solo":""},model:{value:(_vm.form.age),callback:function ($$v) {_vm.$set(_vm.form, "age", $$v)},expression:"form.age"}})],1),_vm._v(" "),_c('mu-form-item',{staticClass:"p-15 border-1px-b",attrs:{"prop":"workAge","label":"从业年限","rules":_vm.workAgeRules}},[_c('mu-text-field',{attrs:{"prop":"workAge","placeholder":_vm.mode !== 1 ? '' : '请输入从业年限',"disabled":_vm.mode !== 1,"solo":""},model:{value:(_vm.form.workAge),callback:function ($$v) {_vm.$set(_vm.form, "workAge", $$v)},expression:"form.workAge"}})],1),_vm._v(" "),_c('mu-form-item',{staticClass:"p-15 border-1px-b",attrs:{"prop":"company","label":"公司名称","rules":_vm.companyRules}},[_c('mu-text-field',{attrs:{"prop":"company","placeholder":_vm.mode !== 1 ? '' : '请输入公司名称',"disabled":_vm.mode !== 1,"solo":""},model:{value:(_vm.form.company),callback:function ($$v) {_vm.$set(_vm.form, "company", $$v)},expression:"form.company"}})],1),_vm._v(" "),(_vm.mode === 1)?_c('div',{staticClass:"flex aic jcc"},[_c('mu-button',{directives:[{name:"loading",rawName:"v-loading",value:(_vm.loading),expression:"loading"}],staticClass:"background-primary",attrs:{"color":"#fff","data-mu-loading-size":"24","disabled":_vm.loading,"flat":""},on:{"click":_vm.submit}},[_vm._v("提交\n                ")]),_vm._v(" "),_c('mu-button',{staticClass:"ml-15",attrs:{"flat":""},on:{"click":_vm.clear}},[_vm._v("重置")]),_vm._v(" "),_c('mu-button',{staticClass:"ml-15",attrs:{"color":"#ccc","flat":""},on:{"click":_vm.over}},[_vm._v("取消")])],1):_vm._e()],1),_vm._v(" "),(_vm.mode === 0)?_c('mu-button',{staticClass:"db ma w90 background-primary",attrs:{"color":"#fff","flat":""},on:{"click":_vm.handlerToggleMode}},[_vm._v("\n            修改\n        ")]):_vm._e()],1),_vm._v(" "),_c('mu-bottom-sheet',{attrs:{"open":_vm.open,"lock-scroll":""},on:{"update:open":function($event){_vm.open=$event}}},[_c('mu-list',{on:{"item-click":_vm.closeBottomSheet}},[_c('mu-list-item',{attrs:{"button":""},on:{"click":function($event){_vm.handlerToggleGender('男')}}},[_c('mu-list-item-action',[_c('mu-icon',{attrs:{"value":"sentiment_satisfied","color":"#2196f3"}})],1),_vm._v(" "),_c('mu-list-item-title',[_vm._v("男")])],1),_vm._v(" "),_c('mu-list-item',{attrs:{"button":""},on:{"click":function($event){_vm.handlerToggleGender('女')}}},[_c('mu-list-item-action',[_c('mu-icon',{attrs:{"value":"face","color":"#e91e63"}})],1),_vm._v(" "),_c('mu-list-item-title',[_vm._v("女")])],1)],1)],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ var about_data_info = (esExports);
// CONCATENATED MODULE: ./src/views/about/data/info.vue
function injectStyle (ssrContext) {
  __webpack_require__("jDbW")
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-f2f2effc"
